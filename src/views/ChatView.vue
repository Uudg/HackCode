            ...
            <form>
              <label
                ...
                <button @click="($event) => msg($event)">
                  <img :src="require('@/assets/img/plane.svg')" alt="" />
                </button>
              </label>
            </form>
            <v-row>
              <p v-if="hasNavigatorMedia">Your browser does not support this feature</p>
              <div v-else ref="containerRef" class="audio-wrapper"></div>
            </v-row>
